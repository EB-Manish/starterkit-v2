...
/**
 * Block Name: Hero Section Five
 *
 * This is the template that displays the Hero section Five
 */
...
?>
    <section id="<?php echo $id; ?>" class="section section-hero section-hero-five d-flex align-items-center <?php echo $padding_type . ' ' . $padding; ?>">
        <?php if ($bg_image) { ?>
