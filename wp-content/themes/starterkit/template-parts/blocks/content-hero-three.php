...
/**
 * Block Name: Hero Section Three
 *
 * This is the template that displays the Hero section Three
 */
...
$id = 'hero-section-three-' . $block['id'];
...
if ($section_enable) {
    ...
    $section_heading_class = 'section-heading-right';
    $img_pos_class = '';
    if ($image_position == 'right') {
        $img_pos_class = 'order-md-1';
        $section_heading_class = 'section-heading-left';
    }

?>
    <section id="<?php echo $id; ?>" class="section section-hero section-hero-three <?php echo $padding_type . ' ' . $padding; ?>">
        <div class="container container-wrapper">
            <div class="row justify-content-between align-items-center">
                ...
                <?php if ($title != '' || $description != '') { ?>
                    <div class="col-12 col-md-5 section-heading <?php echo $section_heading_class ?>">

                        <?php if ($title != '') { ?>
                            <h1 class="section-heading__title title"><?php echo $title; ?></h1>
                        ...
                        <?php if ($link != '') { ?>
                            <div class="section-heading__btn btn-wrapper">
                                <a href="<?php echo $link['url'] ?>" class="btn btn-primary" <?php if ($link['target']) { ?>target="_blank" <?php } ?>>
