...
/**
 * Block Name: Blog Listing 2
 *
 * This is the template that displays the Blog Listing 2 block.
 */
...
if ($section_enable) {
?>
    <section id="<?php echo $id; ?>" class="section section-blog-listing section-blog-listing-two <?php echo $padding_type . ' ' . $align_class . ' ' . $padding; ?>">
        <div class="container">
            <div class="row justify-content-center">
                <?php get_template_part('template-parts/blog-component/all-posts'); ?>
            </div>
        </div>
    </section>
<?php } ?>