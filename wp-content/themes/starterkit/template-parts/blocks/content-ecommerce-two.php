...
/**
 * Block Name: Ecommerce Two
 *
 * This is the template that displays the Ecommerce Two
 */
...
?>
        <section id="<?php echo $id; ?>" class="section section-ecommerce-two <?php echo $padding_type . ' ' . $padding; ?>">
            <div class="container">
                <?php
                if ($select_products) {
                    $count = 1;
                ?>
                    <div class="row">
                        ...
                        ?>
                            <div class="col-md-6 product-wrap<?= $col_class; ?>">
                                <div class="product<?= $large_product; ?>">
...
<?php else : ?>
    <div class="container ecommerce-block-error mb-3">
        <div class="bg-danger text-white p-3">
            Please install and activate WooCommerce to use this block (Ecommerce Two).
        </div>
    </div>
<?php endif; ?>