...
/**
 * Block Name: Hero Section Seven
 *
 * This is the template that displays the Hero section Seven
 */
...
$id = 'hero-section-seven-' . $block['id'];
...
if ($section_enable) {
    ...
    $img_pos_class = ' img-left';
    if ($image_position == 'right') {
        $img_pos_class = ' order-md-1 img-right';
    }

?>
    <section id="<?php echo $id; ?>" class="section section-hero section-hero-seven <?php echo $padding_type . ' ' . $padding; ?>">
        <div class="container container-wrapper">
            <div class="row justify-content-between align-items-center">
                <?php if ($image != '') { ?>
                    <div class="col-12 g-0 col-md-4 section-col-img mb-3 mb-md-0 <?php echo $img_pos_class; ?>">
                        <div class="img-wrap">
