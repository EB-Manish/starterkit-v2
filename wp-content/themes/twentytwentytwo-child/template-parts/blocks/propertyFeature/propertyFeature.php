...
<div>
   ...
   <?php if($hasParking){echo "<i class='fa-solid fa-car'></i>parking available"; } ?>
    ...
    <div>
        <?php if($petFrendly){echo "<i class='fa-solid fa-dog'></i>pet Friendly"; } ?>
    </div>
</div>
